...
GAMMA_MAX_PAGES = int(os.getenv("GAMMA_MAX_PAGES", "12"))
WEATHER_WORKERS = 8
CLOB_BATCH_TOKEN_IDS = int(os.getenv("CLOB_BATCH_TOKEN_IDS", "35"))
CLOB_USE_BATCH_ENDPOINT = os.getenv("CLOB_USE_BATCH_ENDPOINT", "false").lower() == "true"
CLOB_PRICE_WORKERS = int(os.getenv("CLOB_PRICE_WORKERS", "12"))
TOKEN_PRICE_CACHE_TTL_SECONDS = int(os.getenv("TOKEN_PRICE_CACHE_TTL_SECONDS", "30"))
